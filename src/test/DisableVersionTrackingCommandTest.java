...
class DisableVersionTrackingCommandTest extends EnvironmentSetup {
	...
	void testExecute(String templateType, String strategyType) {
		...
		mainWindow.getMiDisableVersionTracking().doClick();
		...
		assertEquals(versionTrackingManager.isEnabled(), false);
